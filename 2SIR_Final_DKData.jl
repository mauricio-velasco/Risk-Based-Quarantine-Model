#Denmark:
#Note: Mortality for high_risk group taken from ICL study
...
function simulacion( name; num_dias_simulacion = 350, mu_jov = 82/100000, mu_old= 5.23/100.0, NumC = 2.28, Dur=5.8, fun_1 = alpha_1, fun_2=alpha_2)
    #Common parameters
    c = NumC/Dur
    ...
    N = 8281.0
    u0 = [0.1; 0.01; 7837.864-0.1; 443.166-0.01; 0.0 ; 0.0 ; 0.0; 0.0]
    #
